<footer class="footer">
    ...
    <div class="footer-block author">
        <ul>
            <li> created by <a href="https://github.com/modularcode">Ivan Lekić 154/17 ICT College</a>
            </li>
            <li>
                <a href="https://github.com/modularcode/modular-admin-html#get-in-touch">LinkedIn</a>
            </li>
        </ul>
    </div>
</footer>
